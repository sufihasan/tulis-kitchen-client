...
import navLogo from '../../../assets/tuliNavNew.png';
    ...
    return (
        <div className="navbar bg-base-100">
            <div className="navbar-start mr-8">
                ...
                <img className="w-28 hidden md:block lg:block" src={navLogo} alt="Tuli" />
                <a className="btn btn-ghost font-bold  font-dancingScript text-3xl ">Tuli&apos;s Kitchen</a>
            </div>
